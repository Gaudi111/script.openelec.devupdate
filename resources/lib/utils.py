...
def maybe_confirm_installation(selected=None, installed_build=None):
    if installed_build is not None and selected is not None:
        if selected:
        ...
        # Need to call out to the main script to get the installed_build
